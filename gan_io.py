...
def process_a_image_using_gan(prefix):
    ...
    for model in models:
        ...
        COMMAND = "cd CycleGAN && DATA_ROOT=../s3_files/{} name={} model=one_direction_test phase=test loadSize=500 fineSize=500 gpu=0 cudnn=0 resize_or_crop=\"scale_width\" th test.lua && cd ..".format(prefix, model)
        print(COMMAND)
        os.system(COMMAND)
